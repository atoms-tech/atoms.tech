        ...
        <div className="min-h-screen bg-[#0f0f0f] text-[#B5B5B5] relative">
            <div className="relative z-10">
                <div className="p-8">
                    ...
                    <p className="text-xl mt-4">Landing page temporarily simplified for debugging</p>
                    <p className="mt-2">If you see this, the basic page structure works.</p>
                </div>
                {/* Temporarily comment out all components to identify the hanging one */}
                {/* <Navbar />
