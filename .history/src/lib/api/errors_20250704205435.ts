...
export const createApiError = {
    ...
    payloadTooLarge: (message = 'Payload too large', details?: any) =>
        new ApiErrorClass(
    ...
    gatewayTimeout: (message = 'Gateway timeout', details?: any) =>
        new ApiErrorClass(
    ...
    externalApi: (message = 'External API error', details?: any) =>
        new ApiErrorClass(
