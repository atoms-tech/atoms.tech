...
export const analyticsQueryKeys = {
    ...
    activitiesWithParams: (orgId: string, projectId?: string, params?: AnalyticsQueryParams) => 
        [...analyticsQueryKeys.activities(orgId, projectId), params] as const,
    metrics: (orgId: string, projectId?: string, timeRange?: string) => 
        [...analyticsQueryKeys.all, 'metrics', orgId, projectId, timeRange] as const,
...
export function usePaginatedAnalyticsActivities(
    ...
    return {
        ...
        hasNextPage: query.data ? 
            (params.pagination!.page * params.pagination!.pageSize) < query.data.total : 
            false,
        hasPreviousPage: params.pagination ? params.pagination.page > 1 : false,
        totalPages: query.data && params.pagination ? 
