...
export function StatusRegion({ message, type = 'info', className }: StatusRegionProps) {
...
interface LiveRegionContextType {
    announce: (message: string, type?: 'info' | 'success' | 'warning' | 'error', duration?: number) => void;
    clear: () => void;
}
