...
import {
    OptimizedVideo,
    useVideoPreloader,
} from '@/components/ui/optimized-video';
    ...
    return (
        <div className="space-y-8 p-6">
            <h2 className="text-2xl font-bold">
                Optimized Media Components Examples
            </h2>
            ...
            <section>
                <h3 className="text-lg font-semibold mb-4">
                    Optimized Videos (GIF Replacement)
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Analysis demo video */}
            ...
            <section>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                    <ul className="space-y-2 text-sm">
                        <li>
                            • Use <code>priority={true}</code> for
                            above-the-fold images
                        </li>
                        <li>
                            • Use appropriate <code>config</code> presets for
                            different image types (ICON, AVATAR,
                            HERO_BACKGROUND)
                        </li>
                        <li>
                            • Use <code>OptimizedVideo</code> instead of GIFs
                            for animations
                        </li>
                        ...
                        <li>
                            • Use appropriate quality settings based on image
                            importance
                        </li>
                        <li>
                            • Preload critical videos using{' '}
                            <code>useVideoPreloader</code>
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                    <p className="text-sm">
                        ...
                        performance metrics for optimized images. In development
                        mode, detailed loading information is logged to the
                        console.
                    </p>
                </div>
            </section>
