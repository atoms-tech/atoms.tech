...
function MaterialUITableRow<T extends Record<string, CellValue> & { id: string }>({
    item,
    columns,
    isEditMode,
    isSelected,
    ...
    return (
        <tr className={`border-t hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${
...
function MaterialUICellEditor({ column, value, onChange }: MaterialUICellEditorProps) {
    ...
    return (
        <div className="w-full space-y-4">
            ...
            <div className="text-center text-sm text-muted-foreground">
                ✨ <strong>Material React Table</strong> - Comprehensive interface with inline editing, 
