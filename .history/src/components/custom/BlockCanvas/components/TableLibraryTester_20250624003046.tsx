        ...
        <div className={containerClass}>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="comparison" className="space-y-6">
                    <Card>
                        <CardHeader>
                            <CardTitle>Table Library Comparison</CardTitle>
                            <CardDescription>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div className="p-4 border rounded-lg">
                                    <h3 className="font-semibold mb-2">Default Table</h3>
                                    <p className="text-sm text-muted-foreground mb-2">Lightweight custom implementation</p>
                                    <Badge variant="outline">~12kB</Badge>
                                </div>
                                <div className="p-4 border rounded-lg">
                                    <h3 className="font-semibold mb-2">TanStack Table</h3>
                                    <p className="text-sm text-muted-foreground mb-2">Powerful headless table</p>
                                    <Badge variant="outline">~45kB</Badge>
                                </div>
                                <div className="p-4 border rounded-lg">
                                    <h3 className="font-semibold mb-2">Mantine Table</h3>
                                    <p className="text-sm text-muted-foreground mb-2">Feature-rich with clean design</p>
                                    <Badge variant="outline">~48kB</Badge>
                                </div>
                                <div className="p-4 border rounded-lg">
                                    <h3 className="font-semibold mb-2">Material-UI Table</h3>
                                    <p className="text-sm text-muted-foreground mb-2">Comprehensive Material Design</p>
                                    <Badge variant="outline">~60kB</Badge>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                <TabsContent value="default" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle>Default Table - Live Demo</CardTitle>
                            <CardDescription>Lightweight custom table implementation</CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <TabsContent value="tanstack" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle>TanStack Table - Live Demo</CardTitle>
                            <CardDescription>Powerful headless table with advanced features</CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <TabsContent value="mantine" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle>Mantine React Table - Live Demo</CardTitle>
                            <CardDescription>Feature-rich table with clean design system</CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <TabsContent value="material-ui" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle>Material-UI React Table - Live Demo</CardTitle>
                            <CardDescription>Comprehensive table with Material Design</CardDescription>
                        </CardHeader>
                        <CardContent>
