...
import { BarChart3, Brain, CheckCircle, FileText, Rocket, Shield, Users, Zap } from 'lucide-react';
                ...
                <div className="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                            We&apos;ll help you set up your profile and create
                            your first project. This should take about 2-3
                            minutes.``
                        </p>
