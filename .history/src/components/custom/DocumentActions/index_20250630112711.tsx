...
export function DocumentActions({
    ...
    const handleDuplicate = async (targetProjectId: string, newName?: string) => {
        try {
    ...
    const hasAnyPermission = canPerformAction('edit') || canPerformAction('delete') || canPerformAction('duplicate');
    if (!hasAnyPermission) {
        return null;
    }
