            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        {projectId ? 'Project-level' : 'Organization-level'} activity insights
                    </p>
                </div>
                ...
                <Card>
                    <CardContent className="p-6">
                        ...
                        <div className="mt-2">
                            ...
                            {timeRange === 'month' && metrics.activitiesThisMonth > 0 && (
                                <p className="text-xs text-muted-foreground">
                                    +{metrics.activitiesThisMonth} this month
                                </p>
                            )}
                        </div>
                    </CardContent>
                ...
                <Card>
                    <CardContent className="p-6">
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm font-medium">Blocks</span>
                        </div>
                        <div className="mt-2">
                            <div className="text-2xl font-bold">{metrics.totalBlocks}</div>
                            <p className="text-xs text-muted-foreground">
                                total blocks
                            </p>
                        </div>
                    ...
                    {metrics.mostActiveUsers.length > 0 ? (
                        <div className="space-y-4">
                            <ResponsiveContainer width="100%" height={200}>
                                <BarChart data={metrics.mostActiveUsers.slice(0, 10)}>
                                    <CartesianGrid strokeDasharray="3 3" />
                                    <XAxis 
                                        dataKey="user_name" 
                                        angle={-45}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {metrics.mostActiveUsers.slice(0, 6).map((user, index) => (
