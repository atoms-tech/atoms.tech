...
export function SlashCommandAutocomplete({
    ...
    const style: React.CSSProperties = {
        ...
        ...(state.position && {
            ...
            top: state.position.y + 4, // Small offset below cursor
        }),
    };
    ...
    return (
        <div
            ...
            style={style}
            className={cn(
                'min-w-[300px] rounded-md border bg-popover p-0 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95',
                className
            )}
        >
