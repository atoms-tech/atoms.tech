...
import { ArrowRight, Lightbulb, RefreshCw, Sparkles, TrendingUp } from 'lucide-react';
...
export function AISuggestionsWidget({ instance, onConfigChange }: WidgetProps) {
    const { maxSuggestions = 4, showPriority = true, showConfidence = true } = instance.config || {};
    
    const [suggestions] = useState<AISuggestion[]>([
        {
            id: '1',
            title: 'Optimize Dashboard Layout',
            description: 'Based on your usage patterns, consider moving the Analytics widget to the top-left for better accessibility.',
            type: 'optimization',
            priority: 'medium',
        ...
        },
        {
            ...
            description: 'You frequently check project metrics at 9 AM. Set up automated daily reports to save time.',
            type: 'automation',
            priority: 'high',
        ...
        },
        {
            ...
            description: 'Your team shows peak collaboration between 2-4 PM. Schedule important meetings during this window.',
            type: 'insight',
            priority: 'low',
        ...
        },
        {
            ...
            description: 'Consider breaking down large tasks into smaller ones. Your completion rate increases by 40% with smaller tasks.',
            type: 'improvement',
            priority: 'medium',
        ...
        },
        {
            ...
            description: 'Project Alpha is trending ahead of schedule. Consider reallocating resources to Project Beta.',
            type: 'insight',
            priority: 'high',
    ...
    const getTypeIcon = (type: string) => {
        switch (type) {
            ...
            case 'automation': return <RefreshCw className="h-4 w-4" />;
    ...
    const getTypeColor = (type: string) => {
        switch (type) {
            case 'optimization': return 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300';
            case 'automation': return 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300';
            case 'insight': return 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300';
            case 'improvement': return 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300';
                ...
                {displayedSuggestions.map((suggestion, index) => (
                    <motion.div
                        ...
                        className={`p-3 rounded-lg border transition-all duration-200 hover:shadow-sm group ${
                            showPriority ? getPriorityColor(suggestion.priority) : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800'
                        }`}
                    >
