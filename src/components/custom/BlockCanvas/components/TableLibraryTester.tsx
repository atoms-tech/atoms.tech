...
import { TableLibraryType, useDocumentStore } from '@/store/document.store';
...
const mockColumns = [
    ...
    },
    {
        ...
        header: 'Status',
        type: 'select',
        options: ['Draft', 'In Review', 'Approved', 'Implemented', 'Testing'],
    },
...
const TableLibraryTester: React.FC<TableLibraryTesterProps> = ({
    className,
}) => {
                    ...
                    <div className="text-center space-y-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground max-w-2xl mx-auto">
                                Comprehensive testing environment for all table
                                implementations in ATOMS.tech
                            </p>
                        </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    <TabsList className="grid w-full grid-cols-6 bg-muted">
                        ...
                        <TabsTrigger value="tanstack" className="text-sm">
                            TanStack
                        </TabsTrigger>
                        <TabsTrigger value="mantine" className="text-sm">
                            Mantine
                        </TabsTrigger>
                        <TabsTrigger value="material-ui" className="text-sm">
                            Material-UI
                        </TabsTrigger>
                        <TabsTrigger value="live-test" className="text-sm">
                            Live Test
                        </TabsTrigger>
                    </TabsList>
                        ...
                        <Card className="border bg-card text-card-foreground shadow">
                            <CardHeader className="pb-4">
                                ...
                                <CardDescription className="text-sm text-muted-foreground">
                                    Compare different table implementations
                                    available in ATOMS.tech
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="pt-0">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <Card className="p-4 bg-muted/50">
                                        ...
                                        <p className="text-sm text-muted-foreground mb-3">
                                            Feature-rich with clean design
                                        </p>
                                        <div className="flex items-center justify-between">
                                            <Badge
                                                variant="outline"
                    ...
                    <TabsContent value="tanstack" className="space-y-4 mt-6">
                        <Card className="border bg-card text-card-foreground shadow">
                            <CardHeader className="pb-4">
                                ...
                                <CardDescription className="text-sm text-muted-foreground">
                                    Powerful headless table with advanced
                                    features
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="pt-0">
                    ...
                    <TabsContent value="live-test" className="space-y-4 mt-6">
                        <Card className="border bg-card text-card-foreground shadow">
                            <CardHeader className="pb-4">
                                ...
                                <CardDescription className="text-sm text-muted-foreground">
                                    Test the currently selected table
                                    implementation with real-time switching
                                </CardDescription>
                            </CardHeader>
