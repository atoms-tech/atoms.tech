...
const shortcuts: KeyboardShortcut[] = [
    ...
    { key: 'Ctrl+O', description: 'Create new organization', category: 'Actions' },
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="pt-4 border-t border-gray-700">
                                        <p className="text-xs text-gray-400 text-center">
                                            Press <kbd className="px-1 py-0.5 text-xs bg-gray-700 rounded">?</kbd> anytime to open this help
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
