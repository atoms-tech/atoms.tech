                ...
                <CardContent className="space-y-6">
                            ...
                            {projectTemplates.map((template) => (
                                <div
                                    ...
                                    className={`p-3 rounded-lg border cursor-pointer transition-colors ${
                                        data.projectData.template === template.id
                            ...
                            {visibilityOptions.map((option) => (
                                <div key={option.id} className="flex items-center space-x-2">
                                    <input
                                        ...
                                        id={option.id}
                                        name="visibility"
                                        checked={(data.projectData.visibility || 'private') === option.id}
                    ...
                    >
                        <p className="text-sm text-purple-800 dark:text-purple-200">
                            💡 Don't worry about getting everything perfect - you can always 
                            modify these settings later from your project dashboard.
                        </p>
                    </motion.div>
                </CardContent>
            </Card>
