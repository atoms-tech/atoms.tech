        ...
        >
          ...
          <div className="flex items-center gap-3 p-4 pb-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1">
                <h3 className="font-semibold text-white dark:text-slate-900 text-sm">Agent</h3>
                {isConnected && <Sparkles className="h-3 w-3 text-blue-500 animate-pulse" />}
              </div>
              <p className="text-xs text-slate-300 dark:text-slate-500 truncate">{getStatusText()}</p>
            </div>
          </div>
          ...
          <div className="px-4 pb-4">
            <div className="flex items-center justify-between text-xs">
              <span className="text-slate-300 dark:text-slate-400">Messages: {messages.length}</span>
              {unreadCount > 0 && (
