 ...
 */
export async function generateDocumentScopedRequirementId(documentId: string): Promise<string> {
    try {
 ...
 */
export async function generateProjectScopedRequirementId(projectId: string): Promise<string> {
    try {
